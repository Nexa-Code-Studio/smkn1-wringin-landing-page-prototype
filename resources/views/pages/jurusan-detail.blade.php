...
@section('content')
    ...
    <section class="min-h-screen pt-32 pb-16 lg:pt-0 lg:pb-0 bg-brand-600 relative overflow-hidden text-white flex items-center">
        {{-- Background Elements --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center lg:text-left flex flex-col lg:flex-row items-center gap-12 w-full">
            
            <div class="flex-1">
                <div data-animate="fade-up" class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-xs font-bold uppercase tracking-wide mb-6">
                    <i class="fa-solid fa-code text-secondary-400 animate-pulse"></i>
                    Program Unggulan
                </div>
                
                <h1 data-animate="fade-up" data-delay="100" class="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
                ...
                <div data-animate="fade-up" data-delay="300" class="flex justify-center lg:justify-start">
                    <a href="#deskripsi" class="group flex items-center gap-2 text-white font-semibold hover:text-secondary-400 transition">
                        Selengkapnya 
            ...
            {{-- Hero Image/Graphic for Detail --}}
            <div data-animate="fade-left" data-delay="400" class="lg:w-1/3 w-full max-w-sm relative">
    ...
    <section id="deskripsi" class="py-16 bg-white">
